...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,784 | 🐛 172 | 🌐 TypeScript | 📅 2026-09-17 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,172 | 🐛 793 | 🌐 TypeScript | 📅 2026-09-17 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,653 | 🐛 127 | 🌐 Vue | 📅 2026-09-17 - Ant Design of Vue.js 2.5.0+.
* [vue-antd-admin](https://github.com/iczer/vue-antd-admin) ⭐ 3,662 | 🐛 98 | 🌐 Vue | 📅 2024-05-08 - Ant Design Pro's implementation with Vue
* [Vue.js Beauty](https://github.com/FE-Driver/vue-beauty) ⭐ 2,097 | 🐛 63 | 🌐 JavaScript | 📅 2024-03-06 - Beautiful UI components build with Vue.js and Ant Design.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,535 | 🐛 73 | 🌐 C# | 📅 2026-09-17 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,812 | 🐛 483 | 🌐 JavaScript | 📅 2026-08-14 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [Ng-Alain](https://github.com/cipchk/ng-alain) ⭐ 4,533 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-11 - Angular Admin UI built on Ant Design (with ng-zorro-antd).
...
* [Official Ant Design Icons](http://github.com/ant-design/ant-design-icons) ⭐ 1,090 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-31

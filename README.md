...
* [Dva Cli](https://github.com/dvajs/dva-cli) ⭐ 958 | 🐛 67 | 🌐 JavaScript | 📅 2019-03-17 - Create Ant Design projects based on [Dva.js](https://github.com/dvajs/dva) ⭐ 16,144 | 🐛 29 | 🌐 JavaScript | 📅 2025-08-06, a
...
* [antd-theme-webpack-plugin](https://github.com/mzohaibqc/antd-theme-webpack-plugin) ⭐ 366 | 🐛 73 | 🌐 JavaScript | 📅 2023-01-06 - A webpack plugin to generate your custom theme file.
* [antd-theme-generator](https://github.com/mzohaibqc/antd-theme-generator) ⭐ 358 | 🐛 58 | 🌐 JavaScript | 📅 2023-01-08 - A simple script to generate theme specific less file which can be used in any environment.
* [dynamic-antd-theme](https://github.com/luffyZh/dynamic-antd-theme) ⚠️ Archived - A simple plugin to dynamic change ant-design theme whether less or css.
* [storybook-addon-customize-antd-theme](https://github.com/letshare/storybook-addon-customize-antd-theme) ⭐ 32 | 🐛 6 | 🌐 TypeScript | 📅 2023-10-10 - a Storybook addon help you visually customize an ant design theme.

### Themes

* [ant-design-dark-theme](https://github.com/ant-design/ant-design-dark-theme) ⭐ 476 | 🐛 21 | 🌐 TypeScript | 📅 2021-03-05 - Dark theme variables of Ant Design.
* [ant-design-aliyun-theme](https://github.com/ant-design/ant-design-aliyun-theme) ⭐ 308 | 🐛 7 | 🌐 TypeScript | 📅 2022-08-29 - Aliyun console theme variables of Ant Design.
* [ant-dark-theme](https://github.com/Kuechlin/ant-dark-theme) ⚠️ Archived - Dark theme variables of Ant Design.

## Related Projects

Ant Design family of projects.

* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,779 | 🐛 168 | 🌐 TypeScript | 📅 2026-09-15 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
* [Ant Design Web3](https://github.com/ant-design/ant-design-web3) ⭐ 1,147 | 🐛 62 | 🌐 TypeScript | 📅 2026-07-22 - Efficient react components for building dapps easier | Connect crypto wallets and more Web3 UI components | Web3 icons | Supports Ethereum, Solana, Bitcoin, TON, Sui and others.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,171 | 🐛 796 | 🌐 TypeScript | 📅 2026-09-16 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,651 | 🐛 127 | 🌐 Vue | 📅 2026-09-16 - Ant Design of Vue.js 2.5.0+.
* [vue-antd-admin](https://github.com/iczer/vue-antd-admin) ⭐ 3,661 | 🐛 98 | 🌐 Vue | 📅 2024-05-08 - Ant Design Pro's implementation with Vue
* [Vue.js Beauty](https://github.com/FE-Driver/vue-beauty) ⭐ 2,096 | 🐛 63 | 🌐 JavaScript | 📅 2024-03-06 - Beautiful UI components build with Vue.js and Ant Design.
* [antue](https://github.com/zzuu666/antue) ⭐ 256 | 🐛 1 | 🌐 Less | 📅 2026-03-01 - A set of enterprise-class Vue UI components, following the Ant Design specification completely.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,535 | 🐛 70 | 🌐 C# | 📅 2026-09-15 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [react-lz-editor](https://github.com/leejaen/react-lz-editor) ⭐ 946 | 🐛 102 | 🌐 JavaScript | 📅 2022-12-06 - An open source rich react editor based on draft-Js and ant design.
* [antd-table-infinity](https://github.com/Leonard-Li777/antd-table-infinity) ⭐ 286 | 🐛 40 | 🌐 JavaScript | 📅 2026-02-17 - An infinite scroll component based on antd table that supports virtual scrolling & high-performance
* [antd-amiya](https://github.com/viewweiwu/amiya) ⭐ 138 | 🐛 8 | 🌐 TypeScript | 📅 2023-12-02 - Page level components and with table and form.
* [antd-data-table](https://github.com/NewbeeFE/antd-data-table) ⭐ 125 | 🐛 16 | 🌐 TypeScript | 📅 2019-10-29 - A component that combines antd's Table and Form to do the search, display, and operating jobs for data.
* [antd-phone-input](https://github.com/ArtyomVancyan/antd-phone-input) ⭐ 92 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-22 - Advanced, highly customizable phone input component for Ant Design.
...
* [Sunflower(🌻)](https://github.com/ant-design/sunflower) ⭐ 490 | 🐛 30 | 🌐 TypeScript | 📅 2023-02-04 Collection of React Hooks returning component of antd.
* [use-antd-resizable-header](https://github.com/hemengke1997/use-antd-resizable-header) ⭐ 274 | 🐛 25 | 🌐 TypeScript | 📅 2025-06-10 - A React Hook makes Ant Design Table Header resizable.

## Applications

A list of mature apps built with Ant Design.

* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,805 | 🐛 483 | 🌐 JavaScript | 📅 2026-08-14 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [Antd Admin](https://github.com/zuiidea/antd-admin) ⭐ 9,768 | 🐛 38 | 🌐 TypeScript | 📅 2026-07-27 - A admin dashboard application demo built upon Ant Design and Dva.js.
* [Ng-Alain](https://github.com/cipchk/ng-alain) ⭐ 4,531 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-11 - Angular Admin UI built on Ant Design (with ng-zorro-antd).
...
* [React Redux](https://github.com/Justin-lu/react-redux-antd) ⭐ 415 | 🐛 3 | 🌐 JavaScript | 📅 2024-08-01 - React Redux for CMS/Enterprise class apps (ERP/Admin) built with Ant Design.
* [Typescript React With Mobx Starter](https://github.com/YDJ-FE/ts-react-webpack) ⭐ 362 | 🐛 4 | 🌐 TypeScript | 📅 2023-01-27 - a starter-template with typescript, react, mobx, antd and webpack).
* [react-vite-admin](https://github.com/ychengcloud/react-vite-admin) ⭐ 245 | 🐛 0 | 🌐 TypeScript | 📅 2022-11-10 - React, Recoil, React Query, React Hooks, Typescript, Axios.
* [CL React](https://github.com/chenliang2016/CLReactAntDesign) ⭐ 174 | 🐛 3 | 🌐 JavaScript | 📅 2018-10-22 - Based on Ant Design front-end framework structures for enterprise back-office software.
* [Dva Antd Mobile Starter](https://github.com/xlsdg/dva-antd-mobile-starter) ⭐ 115 | 🐛 2 | 🌐 JavaScript | 📅 2018-11-24 - Get started with Dva.js and Ant Design mobile.
* [CRA-TS-Antd](https://github.com/comerc/cra-ts-antd) ⭐ 113 | 🐛 1 | 🌐 TypeScript | 📅 2017-12-16 - Create-React-App + TypeScript + Ant-Design (without Eject).
* [React Antd Starter](https://github.com/yuzhouisme/react-antd-redux-router-starter) ⭐ 106 | 🐛 0 | 🌐 JavaScript | 📅 2016-03-25 - This project is designed to develop website/web apps using Ant Design and Redux.
* [React Start Kit](https://github.com/jovey-zheng/react-start-kit) ⭐ 106 | 🐛 0 | 🌐 JavaScript | 📅 2017-03-23 - SPA Boilerplate built with React, Webpack, ES6+, Redux, Router, Babel, Express, Ant Design.
* [React Redux Antd Starter](https://github.com/BetaRabbit/react-redux-antd-starter) ⭐ 90 | 🐛 0 | 🌐 JavaScript | 📅 2018-01-15 - Front-end boilerplate built with React, Redux and Ant Design.
* [The Green Meal](https://github.com/VincentCordobes/the-green-meal) ⚠️ Archived - Next.js, PostgreSQL demo app written in TypeScript.
* [Star Admin](https://github.com/pookpal/star-initReact-example) ⭐ 75 | 🐛 2 | 🌐 CSS | 📅 2016-12-12 - Demo app built with React, Ant Design, Redux, React-router, Webpack and Babel.
* [Koa](https://github.com/yukrain/koa-antd-admin) ⭐ 65 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-06 - Example app to build Admin UI built with React, Ant Design and Koa.
* [React Redux Intro](https://github.com/LeuisKen/react-redux-intro) ⭐ 32 | 🐛 0 | 🌐 CSS | 📅 2016-07-26 - Demo app built with Ant Design and can be configured to initialize a Redux dependencies.
* [Dva Antd Starter](https://github.com/xlsdg/dva-antd-starter) ⭐ 27 | 🐛 0 | 🌐 JavaScript | 📅 2018-03-07 - Get started with Dva.js and Ant Design.
* [React Boilerplate](https://github.com/huhulab/react-frontend-boilerplate) ⭐ 19 | 🐛 0 | 🌐 JavaScript | 📅 2016-04-25 - React Admin front-end boilerplate built with Ant Design.
* [Aspnet Core Antd Boilerplate](https://github.com/bang88/aspnet-core-react-antd-boilerplate) ⭐ 19 | 🐛 4 | 🌐 TypeScript | 📅 2019-10-19 - Server Side Rendering with Asp.net core.
* [React Redux Universal](https://github.com/subenksaha/react-redux-universal) ⭐ 18 | 🐛 0 | 🌐 JavaScript | 📅 2017-08-09 - Universal/Isomorphic boilerplate using react router 4 and webpack 2.5+. All latest packages.
* [React-PWA, PawJS and AntDesign](https://github.com/Atyantik/example-pawjs-ant-design) ⭐ 15 | 🐛 2 | 🌐 JavaScript | 📅 2018-11-13 - A pluggable boilerplate with SEO, PWA, SSR, Skeleton, Placeholders, etc. as some of its many features.
* [TODO MVC](https://github.com/cupools/todoMVC-react) ⭐ 10 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-13 - Todo list built with React and Ant Design.
* [Meteor Antd Boilerplate](https://github.com/elmarti/meteor-antd-boilerplate) ⭐ 9 | 🐛 18 | 🌐 JavaScript | 📅 2019-11-06 - A basic social network built using Antd and Meteor. [Example](https://antdmeteor.herokuapp.com/login)
* [Ant Design Pro](http://pro.ant.design/) - An out-of-box UI solution for enterprise applications :fire::fire::fire:
...
* [syn-antd](https://gitlab.com/synqrinus/syn-antd) - Ant Design wrapper for [ClojureScript](https://clojurescript.org/) and [Reagent](https://github.com/reagent-project/reagent) ⭐ 4,889 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 using [shadow-cljs](http://shadow-cljs.org/) with tree-shaking support. As with other ClojureScript libraries, it cross-compiles to JavaScript.
* [Antizer](https://github.com/priornix/antizer) ⭐ 262 | 🐛 17 | 🌐 Clojure | 📅 2020-08-09 - Ant Design library for [ClojureScript](https://clojurescript.org/), an immutable, functional language that cross-compiles to JavaScript.
...
* [Official Ant Design Icons](http://github.com/ant-design/ant-design-icons) ⭐ 1,090 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-31
* [Ant Design Icons](https://github.com/fjc0k/ant-design-icons) ⚠️ Archived - The premium icon font from Ant Design and Ant Design Mobile.
* [Material Design Icons](https://github.com/2fd/ant-design-icons) ⭐ 30 | 🐛 22 | 🌐 TypeScript | 📅 2024-03-18 Material Design Icons for Ant Design
...
* [Fable Ant Design](https://github.com/evilz/fable-ant-design) ⭐ 24 | 🐛 6 | 🌐 F# | 📅 2021-04-29 - Ant Design bindings for Fable Elmish.

## Contributing

Your contributions are always welcome! [Click Here to read the guidelines](https://github.com/websemantics/awesome-ant-design/blob/master/contributing.md) ⭐ 3,297 | 🐛 31 | 📅 2025-07-29.

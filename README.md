...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,786 | 🐛 106 | 📅 2026-09-02
...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,774 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-10 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,170 | 🐛 796 | 🌐 TypeScript | 📅 2026-09-13 - Ant Design of Angular.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,535 | 🐛 69 | 🌐 C# | 📅 2026-09-11 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,797 | 🐛 483 | 🌐 JavaScript | 📅 2026-08-14 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [Ng-Alain](https://github.com/cipchk/ng-alain) ⭐ 4,530 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-11 - Angular Admin UI built on Ant Design (with ng-zorro-antd).

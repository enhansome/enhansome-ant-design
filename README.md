...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,046 | 🐛 106 | 📅 2026-09-02
...
* [ant-design-dark-theme](https://github.com/ant-design/ant-design-dark-theme) ⭐ 475 | 🐛 21 | 🌐 TypeScript | 📅 2021-03-05 - Dark theme variables of Ant Design.
* [ant-design-aliyun-theme](https://github.com/ant-design/ant-design-aliyun-theme) ⭐ 307 | 🐛 7 | 🌐 TypeScript | 📅 2022-08-29 - Aliyun console theme variables of Ant Design.
...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,798 | 🐛 173 | 🌐 TypeScript | 📅 2026-09-20 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,173 | 🐛 796 | 🌐 TypeScript | 📅 2026-09-23 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,662 | 🐛 128 | 🌐 Vue | 📅 2026-09-19 - Ant Design of Vue.js 2.5.0+.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,535 | 🐛 71 | 🌐 C# | 📅 2026-09-22 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [antd-amiya](https://github.com/viewweiwu/amiya) ⭐ 138 | 🐛 0 | 🌐 TypeScript | 📅 2023-12-02 - Page level components and with table and form.
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,825 | 🐛 483 | 🌐 JavaScript | 📅 2026-08-14 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [syn-antd](https://gitlab.com/synqrinus/syn-antd) - Ant Design wrapper for [ClojureScript](https://clojurescript.org/) and [Reagent](https://github.com/reagent-project/reagent) ⭐ 4,888 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 using [shadow-cljs](http://shadow-cljs.org/) with tree-shaking support. As with other ClojureScript libraries, it cross-compiles to JavaScript.
...
* [Official Ant Design Icons](http://github.com/ant-design/ant-design-icons) ⭐ 1,092 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-31

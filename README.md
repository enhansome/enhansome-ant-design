...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,142 | 🐛 100 | 📅 2026-06-30
...
* [Dva Cli](https://github.com/dvajs/dva-cli) ⭐ 959 | 🐛 67 | 🌐 JavaScript | 📅 2019-03-17 - Create Ant Design projects based on [Dva.js](https://github.com/dvajs/dva) ⭐ 16,151 | 🐛 29 | 🌐 JavaScript | 📅 2025-08-06, a
  lightweight front-end framework based on Redux and React and inspired by [Elm](http://elm-lang.org) and [Choo](https://github.com/yoshuawuyts/choo) ⭐ 6,770 | 🐛 44 | 🌐 JavaScript | 📅 2026-02-20.
...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,724 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-10 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,166 | 🐛 783 | 🌐 TypeScript | 📅 2026-08-10 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,619 | 🐛 127 | 🌐 Vue | 📅 2026-08-15 - Ant Design of Vue.js 2.5.0+.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,533 | 🐛 83 | 🌐 C# | 📅 2026-08-15 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [react-lz-editor](https://github.com/leejaen/react-lz-editor) ⭐ 947 | 🐛 102 | 🌐 JavaScript | 📅 2022-12-06 - An open source rich react editor based on draft-Js and ant design.
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,666 | 🐛 486 | 🌐 JavaScript | 📅 2026-08-14 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [Ng-Alain](https://github.com/cipchk/ng-alain) ⭐ 4,528 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-16 - Angular Admin UI built on Ant Design (with ng-zorro-antd).
...
* [React SPA](https://github.com/JasonBai007/reactSPA) ⭐ 512 | 🐛 2 | 🌐 JavaScript | 📅 2017-06-27 - Building SPA with React, Router, ES6, Fetch, Babel, Webpack, Npm, MockJs, FontAwesome, AnimateCSS, Ant Design, LESS and jQuery.
...
* [syn-antd](https://gitlab.com/synqrinus/syn-antd) - Ant Design wrapper for [ClojureScript](https://clojurescript.org/) and [Reagent](https://github.com/reagent-project/reagent) ⭐ 4,884 | 🐛 27 | 🌐 Clojure | 📅 2026-01-23 using [shadow-cljs](http://shadow-cljs.org/) with tree-shaking support. As with other ClojureScript libraries, it cross-compiles to JavaScript.
...
* [Official Ant Design Icons](http://github.com/ant-design/ant-design-icons) ⭐ 1,087 | 🐛 97 | 🌐 TypeScript | 📅 2026-07-06
...
Your contributions are always welcome! [Click Here to read the guidelines](https://github.com/websemantics/awesome-ant-design/blob/master/contributing.md) ⭐ 3,301 | 🐛 32 | 📅 2025-07-29.

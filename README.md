...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,771 | 🐛 172 | 🌐 TypeScript | 📅 2026-09-10 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,645 | 🐛 127 | 🌐 Vue | 📅 2026-09-11 - Ant Design of Vue.js 2.5.0+.
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,791 | 🐛 483 | 🌐 JavaScript | 📅 2026-08-14 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux

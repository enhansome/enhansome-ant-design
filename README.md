...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,750 | 🐛 165 | 🌐 TypeScript | 📅 2026-09-01 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,168 | 🐛 781 | 🌐 TypeScript | 📅 2026-09-01 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,637 | 🐛 123 | 🌐 Vue | 📅 2026-08-26 - Ant Design of Vue.js 2.5.0+.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,531 | 🐛 75 | 🌐 C# | 📅 2026-08-31 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,754 | 🐛 483 | 🌐 JavaScript | 📅 2026-08-14 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [Ng-Alain](https://github.com/cipchk/ng-alain) ⭐ 4,529 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-01 - Angular Admin UI built on Ant Design (with ng-zorro-antd).
...
* [Star Admin](https://github.com/pookpal/star-initReact-example) ⭐ 76 | 🐛 2 | 🌐 CSS | 📅 2016-12-12 - Demo app built with React, Ant Design, Redux, React-router, Webpack and Babel.
...
* [Aspnet Core Antd Boilerplate](https://github.com/bang88/aspnet-core-react-antd-boilerplate) ⭐ 20 | 🐛 4 | 🌐 TypeScript | 📅 2019-10-19 - Server Side Rendering with Asp.net core.
...
* [Official Ant Design Icons](http://github.com/ant-design/ant-design-icons) ⭐ 1,088 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-31

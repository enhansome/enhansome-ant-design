...
* [Dva Cli](https://github.com/dvajs/dva-cli) ⭐ 958 | 🐛 67 | 🌐 JavaScript | 📅 2019-03-17 - Create Ant Design projects based on [Dva.js](https://github.com/dvajs/dva) ⭐ 16,146 | 🐛 29 | 🌐 JavaScript | 📅 2025-08-06, a
  lightweight front-end framework based on Redux and React and inspired by [Elm](http://elm-lang.org) and [Choo](https://github.com/yoshuawuyts/choo) ⭐ 6,767 | 🐛 44 | 🌐 JavaScript | 📅 2026-02-20.
...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,761 | 🐛 167 | 🌐 TypeScript | 📅 2026-09-01 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,169 | 🐛 785 | 🌐 TypeScript | 📅 2026-09-02 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,641 | 🐛 127 | 🌐 Vue | 📅 2026-09-04 - Ant Design of Vue.js 2.5.0+.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,532 | 🐛 72 | 🌐 C# | 📅 2026-09-04 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [antd-phone-input](https://github.com/ArtyomVancyan/antd-phone-input) ⭐ 93 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-22 - Advanced, highly customizable phone input component for Ant Design.
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,762 | 🐛 483 | 🌐 JavaScript | 📅 2026-08-14 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [Ng-Alain](https://github.com/cipchk/ng-alain) ⭐ 4,530 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-02 - Angular Admin UI built on Ant Design (with ng-zorro-antd).
